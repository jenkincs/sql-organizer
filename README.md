...
2. Run **Scan**, then configure an OpenAI model and set its key in SecretStorage. Optionally configure an OpenAI-compatible Base URL and select either the `responses` or `chat-completions` protocol.
