...
import { ClassificationRecord, OrganizerPlan, PlanAction, SqlInventoryItem } from '../domain/models';
...
export function buildPlan(
  ...
  return {
    ...
    warnings: ['Plan is a dry run. Similar SQL is never moved or merged automatically.'],
    status: 'reviewing',
  };
}
